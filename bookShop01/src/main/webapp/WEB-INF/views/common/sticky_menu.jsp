...
function goodsDetail(){
    ...
    formObj.method="get";
    formObj.action="http://localhost:8091/bookshop01/goods/goodsDetail.do?goods_id="+goods_id;
    formObj.submit();
...
<body>    
	...
	<ul>
		<li><a href="#">
		   <img	width="24" height="24" src="${pageContext.request.contextPath}/resources/image/facebook_icon.png">
				페이스북
		</a></li>
		<li><a href="#">
		   <img width="24" height="24" src="${pageContext.request.contextPath}/resources/image/twitter_icon.png">
			트위터
		</a></li>
		<li><a href="#">
		   <img	width="24" height="24" src="${pageContext.request.contextPath}/resources/image/rss_icon.png">
				RSS 피드
		 </a></li>
	</ul>
	<div class="recent">
