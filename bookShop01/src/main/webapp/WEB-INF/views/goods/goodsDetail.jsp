...
function fn_reviewClose(){
	...
	$('#layer_review').attr('style', 'display:none');
	
}

function fn_reClose(){
	
	$('#tbl_review').attr('style', 'display:none');
	...
	<div id="container">
		...
		<div class="tab_container">
			...
			<div class="tab_content" id="tab6">
                ...
                <center>	
    <form  name="frmReview" >                			
				<table border=3   class="list_view" style="border-color: red;border-style: solid;">
				  <tr>
                  ...
                  <tr  align="center">
                    <td> </td>  
                     <td>
                         ...
                         <input type="button" value="취소하기"  onClick="fn_reClose()" id="btn_reClose"/>
                      </td>
                  </tr>
                </table>
              </center>
...
<form action='${pageContext.request.contextPath}/goods/goodsDetail.do'>				
        <input  name="btn_review_modify" type="button"  value="수정" onClick="fn_review_modify()">
		<input  name="btn_review_close" type="button"  value="닫기" onClick="fn_reviewClose()">
			<div>
		</div>
</form>
</body>
